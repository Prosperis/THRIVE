...
export function DashboardCustomizer() {
  ...
  const { widgets: customWidgets, toggleWidget: toggleCustomWidget, deleteWidget } = useCustomWidgetsStore();

  const visibleCount = widgets.filter((w) => w.visible).length + customWidgets.filter((w) => w.visible).length;
