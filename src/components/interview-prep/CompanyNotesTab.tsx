...
import { Plus, Building2, ExternalLink, Edit, Trash2, CheckCircle2 } from 'lucide-react';
                  ...
                  <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="salaryCurrency" className="text-xs text-muted-foreground">Currency</Label>
                          <Input 
                            name="salaryCurrency" 
                            placeholder="USD"
              ...
              <CardContent className="space-y-4">
                ...
                {note.interviewProcess && (
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground whitespace-pre-wrap">{note.interviewProcess}</p>
                  </div>
                )}
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              {searchQuery ? 'No companies match your search' : 'Start adding companies to track your research'}
            </p>
            {!searchQuery && (
