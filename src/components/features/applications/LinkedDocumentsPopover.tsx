...
import { getDocumentTypeColors, getDocumentTypeIcon } from '@/lib/utils';
    ...
    <>
        ...
        >
          <div className="p-3 border-b space-y-2 animate-slideDown">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select
                value={sortBy}
                onValueChange={(value) => setSortBy(value as 'name' | 'date' | 'version' | 'type')}
              >
                <SelectTrigger className="h-7 text-xs flex-1">
                  ...
                  {filteredAndSortedDocuments.map((doc, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`p-2 rounded-md border transition-all duration-200 hover:shadow-sm hover:scale-[1.01] ${colors.bg} ${colors.border}`}
                        >
                          {/* Document Header */}
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <div className="flex items-center gap-1 shrink-0">
                                  {(() => {
                                    ...
                                    const isOutdated =
                                      linkedVersion && linkedVersion.version < doc.version;
                              ...
                              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                                <Badge
                                  variant="outline"
                                  className={`text-[10px] h-4 px-1.5 shrink-0 ${colors.badge}`}
                                >
                              ...
                              {doc.content && (
                                ...
                                >
                                  ...
                                  <span>
                                    {expandedPreview === doc.id ? 'Hide preview' : 'Show preview'}
                                  </span>
                                </button>
                              )}
                            </div>
      ...
      {comparingDocument && (
        <VersionComparisonDialog
          ...
          linkedVersion={
            getLinkedVersion(comparingDocument.id)?.version || comparingDocument.version
          }
