import { Clock, GitBranch, Briefcase, Calendar, ChevronDown, Pencil, Check, X } from 'lucide-react';
  ...
  const timeline = useMemo(() => {
    ...
    for (let v = 1; v <= document.version; v++) {
      ...
      if (v === document.version) {
        ...
        versionDate = apps.reduce((earliest, app) => 
          app.linkedAt < earliest ? app.linkedAt : earliest,
          apps[0].linkedAt
        );
      }
                            ...
                            <>
                              <div className="flex items-center gap-2">
                                ...
                                <Button
                                  ...
                                  onClick={() => handleEditVersionName(node.version, document.versionName)}
      ...
      <div className="pt-3 border-t">
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span>
              {timeline.reduce((sum, node) => sum + node.applications.length, 0)}{' '}
              total applications
            </span>
          </div>
        </div>
