...
export function StatCard({
  ...
  const displayValue = typeof value === 'number' && enableAnimation && !Number.isNaN(numericValue)
  ...
  return (
    <AnimatedCard 
      ...
      className={cn(
        className,
        isPulsing && enableAnimation && 'ring-2 ring-primary/20 ring-offset-2 transition-all duration-500'
      )}
    >
